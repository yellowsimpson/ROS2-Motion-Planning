...
def generate_launch_description():
    ...
    pkg_navigation_stack = FindPackageShare('mobile_manip_moveit_config')
    default_rviz_config_path = PathJoinSubstitution([pkg_navigation_stack, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the mobile_manip_moveit_config package
    model_arg = DeclareLaunchArgument(
        'model', default_value='mri.urdf',
    ...
    urdf = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'mobile_manip_moveit_config',
